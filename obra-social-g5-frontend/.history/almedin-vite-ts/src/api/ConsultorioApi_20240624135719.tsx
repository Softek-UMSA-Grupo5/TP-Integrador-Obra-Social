...
import { ConsultorioCreateRequest, ConsultorioResponseDto} from '../types/Horario'; // Ajusta el import según tus tipos y rutas
import { MedicoRequestDto, MedicoResponseDto } from '../types/Medico'; // Ajusta el import según tus tipos y rutas
