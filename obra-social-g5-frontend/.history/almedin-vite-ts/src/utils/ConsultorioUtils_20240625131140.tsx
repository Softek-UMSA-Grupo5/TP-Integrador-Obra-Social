...
// utils.js (o utils.ts si estás usando TypeScript)
export const handleTimeChange = (type, value, officeData, setOfficeData) => {
...
export const handleSelectChange = (index, value, officeData, setOfficeData) => {
...
export const handleRemoveHorario = (index, officeData, setOfficeData) => {
