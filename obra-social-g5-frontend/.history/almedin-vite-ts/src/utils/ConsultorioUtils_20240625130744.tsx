...
// En utils.js (o utils.ts si estás usando TypeScript)
export const handleTimeChange = (type: 'inicio' | 'fin', value: string, officeData, setOfficeData) => {
...
export const handleSelectChange = (index: number, value: string, officeData, setOfficeData) => {
...
export const handleRemoveHorario = (index: number, officeData, setOfficeData) => {
...
export const handleAddHorario = (officeData, setOfficeData) => {
    setOfficeData((prevData) => ({
        ...prevData,
        horarioAtencion: [
