                    ...
                    <Grid container spacing={2}>
                        ...
                        {officeData.horarioAtencion.map((horario, index) => (
                            <Grid container spacing={2} key={index} my={2} ml={3}>
                                ...
                                <Grid item xs={3}>
                                    <FormControl fullWidth variant="outlined">
                                        <InputLabel shrink sx={{fontWeight:'bold', fontSize:'16px'}}>Hora Inicio</InputLabel>
                                        <OutlinedInput
                                            name="horaInicio"
                                            type="time"
                                ...
                                <Grid item xs={3}>
                                    <FormControl fullWidth variant="outlined">
                                        <InputLabel shrink sx={{fontWeight:'bold', fontSize:'16px'}}>Hora Fin</InputLabel>
                                        <OutlinedInput
                                            name="horaFin"
                                            type="time"
                                ...
                                <Grid item xs={1}>
                                    <IconButton
                                        ...
                                        size="large"
                                        sx={{ '&:hover': { color: 'red', padding:'auto', margin:'auto' }}}>
                                        <DeleteIcon />
                                    </IconButton>
                                </Grid>
                            </Grid>
                        ...
                        <Grid item xs={12}>
                            <FormControl component="fieldset">
                                <h4 style={{ marginBottom: '10px' }}>Seleccione una opción para médico:</h4>
                                <div
                                    style={{
                                        display: 'flex',
                                        alignItems: 'center',
                                        ...
                                        <Grid container spacing={1}>
                                            <Grid item xs={6}>
                                                <FormControl
                                                    ...
                                                    variant="outlined"
                                                    sx={{ my: 0.5 }}>
                                                    <InputLabel shrink sx={{fontWeight:'bold', fontSize:'16px'}}>Nombre</InputLabel>
                                                    <OutlinedInput
                                                        name="nombre"
                                            ...
                                            <Grid item xs={6}>
                                                <FormControl
                                                    ...
                                                    variant="outlined"
                                                    sx={{ my: 0.5 }}>
                                                    <InputLabel shrink sx={{fontWeight:'bold', fontSize:'16px'}}>Apellido</InputLabel>
                                                    <OutlinedInput
                                                        name="apellido"
                                            ...
                                            <Grid item xs={6}>
                                                <FormControl
                                                    ...
                                                    variant="outlined"
                                                    sx={{ my: 0.5 }}>
                                                    <InputLabel shrink sx={{fontWeight:'bold', fontSize:'16px'}}>Teléfono</InputLabel>
                                                    <OutlinedInput
                                                        name="telefono"
                                            ...
                                            <Grid item xs={6}>
                                                <FormControl
                                                    ...
                                                    variant="outlined"
                                                    sx={{ my: 0.5 }}>
                                                    <InputLabel shrink sx={{fontWeight:'bold', fontSize:'16px'}}>Email</InputLabel>
                                                    <OutlinedInput
                                                        name="email"
                                            ...
                                            <Grid item xs={6}>
                                                <FormControl
                                                    ...
                                                    variant="outlined"
                                                    sx={{ my: 0.5 }}>
                                                    <InputLabel shrink sx={{fontWeight:'bold', fontSize:'16px'}}>DNI</InputLabel>
                                                    <OutlinedInput
                                                        name="dni"
                                                        type="text"
                                            ...
                                            <Grid item xs={6}>
                                                <FormControl
                                                    ...
                                                    variant="outlined"
                                                    sx={{ my: 0.5 }}>
                                                    <InputLabel shrink sx={{fontWeight:'bold', fontSize:'16px'}}>CUIL</InputLabel>
                                                    <OutlinedInput
                                                        name="cuil"
                                            ...
                                            <Grid item xs={6}>
                                                <FormControl
                                                    ...
                                                    variant="outlined"
                                                    sx={{ my: 0.5 }}>
                                                    <InputLabel shrink sx={{fontWeight:'bold', fontSize:'16px'}}>Especialidad</InputLabel>
                                                    <OutlinedInput
                                                        name="especialidad"
