                                ...
                                <Grid item xs={4}>
                                    <FormControl fullWidth variant="outlined">
                                        ...
                                        <Select
                                            ...
                                            <MenuItem value="LUNES" sx={{':hover':{backgroundColor: 'lightgray'}}}>LUNES</MenuItem>
                                            <MenuItem value="MARTES" sx={{':hover':{backgroundColor: 'lightgray'}}}>MARTES</MenuItem>
                                            <MenuItem value="MIERCOLES" sx={{':hover':{backgroundColor: 'lightgray'}}}>MIERCOLES</MenuItem>
                                            <MenuItem value="JUEVES" sx={{':hover':{backgroundColor: 'lightgray'}}}>JUEVES</MenuItem>
                                            <MenuItem value="VIERNES" sx={{':hover':{backgroundColor: 'lightgray'}}}>VIERNES</MenuItem>
                                        </Select>
                                    </FormControl>
                                </Grid>
                                <Grid item xs={2.5}>
