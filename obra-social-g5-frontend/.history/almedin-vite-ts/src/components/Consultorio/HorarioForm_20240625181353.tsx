...
interface HorarioFormProps {
    ...
    handleAddHorario: () => void; // Cambiado para reflejar que se maneja en el ConsultorioForm
}
...
const HorarioForm: React.FC<HorarioFormProps> = ({
    ...
    handleTimeChange,
    handleRemoveHorario,
    handleAddHorario, // Se usa directamente desde las props
}) => {

    const handleDefaultHorario = (): Horario => ({
        diaSemana: HorarioDiaSemanaEnum.LUNES, // Ejemplo de valor por defecto
        horaInicio: '08:00:00', // Ejemplo de valor por defecto
        horaFin: '12:00:00', // Ejemplo de valor por defecto
    });
        ...
        <>
            ...
            <Grid item xs={4}>
                <Button
                    variant="outlined"
                    color="primary"
                    onClick={() => handleAddHorario(handleDefaultHorario())}
                    sx={{ mx: 25, width: '100%' }}>
                    Agregar Horario
                </Button>
            </Grid>
