...
const ConsultorioForm: React.FC = () => {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if (!validateFields()) {
            ...
            setErrorMessage(
                'Errores de validación. Por favor, revise los campos e inténtelo nuevamente.'
            );
            return;
        }
        ...
        try {
            ...
            if (createNewMedico) {
                ...
                setSuccessMessage('Consultorio y médico creados correctamente.');
            } else {
            ...
            setErrorMessage(
                'Error al crear el consultorio y/o médico. Por favor, inténtelo nuevamente.'
            );
        }
    };
