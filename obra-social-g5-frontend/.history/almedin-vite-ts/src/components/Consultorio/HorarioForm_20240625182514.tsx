...
import { Grid, FormControl, InputLabel, Select, MenuItem, IconButton, Button, Typography } from '@mui/material';
...
const HorarioForm: React.FC<HorarioFormProps> = ({
    ...
    const handleRemoveHorarioWrapper = (index: number) => {
        if (horarioAtencion.length > 1) {
            ...
            setErrorMessage(''); // Limpiar mensaje de error si se elimina un horario válido
        } else {
            setErrorMessage('No se pueden borrar todos los horarios.'); // Mostrar mensaje de error
        }
    };
