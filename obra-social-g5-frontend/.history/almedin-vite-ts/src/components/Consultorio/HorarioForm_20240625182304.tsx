...
import { Grid, FormControl, InputLabel, Select, MenuItem, IconButton, Button, Snackbar } from '@mui/material';
...
const HorarioForm: React.FC<HorarioFormProps> = ({
    ...
    const handleRemoveHorarioWrapper = (index: number) => {
        if (horarioAtencion.length > 1) {
            ...
            setSnackbarOpen(true); // Mostrar Snackbar si se intenta eliminar el último horario
        }
    };
    ...
    return (
        <>
            ...
            <Snackbar
                ...
                message="No se pueden borrar todos los horarios."
