...
const HorarioForm: React.FC<HorarioFormProps> = ({
    ...
    const handleRemoveHorarioWrapper = (index: number) => {
        if (horarioAtencion.length > 1) {
            ...
            // Implementar lógica para mostrar un mensaje o bloquear la eliminación del último horario
            alert('No se pueden borrar todos los horarios.');
            // Podrías también mostrar un mensaje en una Snackbar o un componente de alerta.
        }
    };
