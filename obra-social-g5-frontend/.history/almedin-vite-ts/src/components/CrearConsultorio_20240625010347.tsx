...
const ConsultorioForm: React.FC = () => {
    ...
    if (name === 'altura') {
        // Parseamos el valor de 'altura' a un número o dejamos null si es inválido
        const alturaValue = value === '' ? null : parseInt(value, 10);

        setOfficeData((prevData) => ({
            ...prevData,
            ubicacion: {
                ...prevData.ubicacion,
                altura: isNaN(alturaValue) ? null : alturaValue,
            },
        }));
    } else {
        setOfficeData((prevData) => ({
                            ...
                            <Grid
                                ...
                                <Grid item xs={3}>
                                    <FormControl fullWidth>
                                        <InputLabel htmlFor={`select-hora-inicio-${index}`}>
                                            Hora Inicio
                                        </InputLabel>
                                        <Select
                                ...
                                <Grid item xs={3}>
                                    <FormControl fullWidth>
                                        <InputLabel htmlFor={`select-hora-fin-${index}`}>
                                            Hora Fin
                                        </InputLabel>
                                        <Select
