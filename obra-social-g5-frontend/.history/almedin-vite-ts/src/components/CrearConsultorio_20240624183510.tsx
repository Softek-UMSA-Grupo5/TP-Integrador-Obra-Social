...
const ConsultorioForm: React.FC = () => {
    ...
    const [selectedMedicoOption, setSelectedMedicoOption] = useState<string>('none');
    useEffect(() => {
                        ...
                        <Grid item xs={12}>
                            <FormControl component="fieldset">
                                ...
                                <div
                                    ...
                                    <FormControl component="fieldset">
                                        <FormLabel component="legend">Seleccionar Médico</FormLabel>
                                        <RadioGroup
                                            name="medicoOptions"
                                            value={selectedMedicoOption}
                                            onChange={handleRadioChange}>
                                            <FormControlLabel
                                                value="createNewMedico"
                                                control={<Radio />}
                                                label="Crear Nuevo Médico"
                                            />
                                            <FormControlLabel
                                                value="selectExistingMedico"
                                                control={<Radio />}
