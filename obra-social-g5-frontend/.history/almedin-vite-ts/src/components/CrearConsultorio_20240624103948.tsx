...
const ConsultorioForm: React.FC = () => {
    const [officeData, setOfficeData] = useState<ConsultorioCreateRequest>({
         horarioAtencion: [], // Aquí deberías inicializar los horarios según tu lógica
    ubicacion: {
      id: 0, // Asegúrate de inicializar correctamente según la estructura de Ubicacion
      ciudad: '',
      provincia: '',
      calle: '',
      altura: 0,
   ...
   const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await createConsultorio(officeData);
