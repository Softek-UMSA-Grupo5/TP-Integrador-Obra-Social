        ...
        try {
            ...
            if (createNewMedico) {
                ...
                const medicoToCreate: MedicoRequestDto = {
                    nombre: '', // Rellena con los datos correctos del médico
                    apellido: '',
                    telefono: '',
                    email: '',
                    dni: 0,
                                        ...
                                        <>
                                            ...
                                            <Grid item xs={6}>
                                                <FormControl
                                                    ...
                                                    <OutlinedInput
                                                        ...
                                                        type="date"
                                                        value={setMedicoData.fechaNacimiento}
                                                        onChange={handleMedicoDataChange}
                                                        sx={{ my: 1 }}
                                                        placeholder="Ingrese la fecha de nacimiento del médico"
                                                        inputProps={{
                                                            max: getFormattedDate(new Date()), // Cambiar esto según tu lógica para la fecha máxima permitida
                                                        }}
                                                    />
                                                </FormControl>
                                            </Grid>
                                            ...
                                            <Grid item xs={6}>
                                                <FormControl
                                                    ...
                                                    <OutlinedInput
                                                        name="especialidad"
                                                        value={setMedicoData.especialidad}
                                                        onChange={handleMedicoDataChange}
                                                        sx={{ my: 1 }}
