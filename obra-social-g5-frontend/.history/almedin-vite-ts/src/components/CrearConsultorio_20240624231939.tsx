...
const ConsultorioForm: React.FC = () => {
    ...
    useEffect(() => {
        // Aquí puedes incluir tu lógica para cargar datos iniciales si es necesario
    }, []);
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            // Aquí puedes incluir la lógica para enviar los datos del formulario
            console.log('Datos del formulario:', officeData, horario);
        } catch (error) {
