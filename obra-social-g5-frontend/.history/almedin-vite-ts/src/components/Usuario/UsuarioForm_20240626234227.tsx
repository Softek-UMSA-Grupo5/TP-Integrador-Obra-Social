                ...
                <form onSubmit={handleSubmit}>
                    <Grid container spacing={2} p={5}>
                        ...
                        <Grid item xs={12}>
                            <FormControl fullWidth variant="outlined">
                                <InputLabel
                                shrink sx={{ fontWeight: 'bold', fontSize: '16px' }}>Password</InputLabel>
                                <OutlinedInput
                                    name="password"
                                    type="password"
                        ...
                        <Grid item xs={12}>
                            <FormControl fullWidth variant="outlined">
                                <InputLabel
                                shrink sx={{ fontWeight: 'bold', fontSize: '16px' }}>Email</InputLabel>
                                <OutlinedInput
                                    name="email"
                        ...
                        <Grid item xs={12}>
                            <FormControl fullWidth variant="outlined">
                                <InputLabel
                                shrink sx={{ fontWeight: 'bold', fontSize: '16px' }}>Rol</InputLabel>
                                <Select
                                    value={selectedRol}
