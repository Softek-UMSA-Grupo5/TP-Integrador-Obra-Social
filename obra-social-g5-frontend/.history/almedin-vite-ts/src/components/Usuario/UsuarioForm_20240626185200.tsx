...
import { createConsultorio, getAllConsiltorios } from '../../axios/ConsultorioApi'; // Ajusta la importación según tu estructura
...
const UsuarioForm: React.FC = () => {
    ...
    const fetchConsultorios = async () => {
        try {
            const consultorios = await getAllConsiltorios();
            setConsultorios(consultorios); // Asegúrate de que getAllConsiltorios devuelve ConsultorioResponseDto[]
        } catch (error) {
