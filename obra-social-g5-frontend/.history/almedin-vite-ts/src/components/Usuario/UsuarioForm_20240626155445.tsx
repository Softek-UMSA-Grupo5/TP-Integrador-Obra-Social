...
const UsuarioForm: React.FC = () => {
    ...
    const consultorios: ConsultorioResponseDto[] = [
        { id: 1, horarioAtencion: [], ubicacion: { ciudad: 'Ciudad A', provincia: 'Provincia A', calle: 'Calle A', altura: 123 }, estaEliminado: false, codigo: 'CONS001', medicoId: 1 },
        { id: 2, horarioAtencion: [], ubicacion: { ciudad: 'Ciudad B', provincia: 'Provincia B', calle: 'Calle B', altura: 456 }, estaEliminado: false, codigo: 'CONS002', medicoId: 2 },
    ];
