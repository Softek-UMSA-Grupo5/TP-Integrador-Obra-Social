     ...
     const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (createNewMedico) {
                ...
                const medicoToCreate = { ...medicoData, consultoriosId: [consultorioId] };
                const medicoResponse = await createMedico(medicoToCreate);
                const medicoId = medicoResponse.data.id;

                // Paso 3: Actualizar el consultorio con el medicoId
                await updateConsultorio(consultorioId, { medicoId });
