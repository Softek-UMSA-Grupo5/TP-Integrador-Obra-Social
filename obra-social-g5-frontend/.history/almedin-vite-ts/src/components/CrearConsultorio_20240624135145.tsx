...
const ConsultorioForm: React.FC = () => {
    ...
    try {
        ...
        const consultorioId = consultorioResponse.response.data.id; // Asumiendo que el ID se recibe directamente en la respuesta
        ...
        if (createNewMedico) {
            ...
            const medicoId = medicoResponse?.data?.id; // Asumiendo que el ID se recibe directamente en la respuesta
