                                ...
                                <Grid item xs={4}>
                                    <FormControl fullWidth variant="outlined">
                                        ...
                                        <Select
                                            ...
                                            <MenuItem value="LUNES" sx={{'&:hover':{backgroundColor: '#000', color:'#fff'},'&.Mui-selected:hover':{backgroundColor: '#000', color:'#fff'}}}>LUNES</MenuItem>
                                            <MenuItem value="MARTES" sx={{'&:hover':{backgroundColor: '#000', color:'#fff'},'&.Mui-selected:hover':{backgroundColor: '#000', color:'#fff'}}}>MARTES</MenuItem>
                                            <MenuItem value="MIERCOLES" sx={{'&:hover':{backgroundColor: '#000', color:'#fff'},'&.Mui-selected:hover':{backgroundColor: '#000', color:'#fff'}}}>MIERCOLES</MenuItem>
                                            <MenuItem value="JUEVES" sx={{'&:hover':{backgroundColor: '#000', color:'#fff'},'&.Mui-selected:hover':{backgroundColor: '#000', color:'#fff'}}}>JUEVES</MenuItem>
                                            <MenuItem value="VIERNES" sx={{'&:hover':{backgroundColor: '#000', color:'#fff'},'&.Mui-selected:hover':{backgroundColor: '#000', color:'#fff'}}}>VIERNES</MenuItem>
                                        </Select>
                                    </FormControl>
                                </Grid>
                                <Grid item xs={2.5}>
