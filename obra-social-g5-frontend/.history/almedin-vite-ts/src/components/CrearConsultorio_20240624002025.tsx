                                ...
                                <Grid item xs={4}>
                                    <FormControl fullWidth variant="outlined">
                                        ...
                                        <Select
                                            ...
                                            <MenuItem value="LUNES" sx={{":hover":bgcolor:#000}}>LUNES</MenuItem>
                                            <MenuItem value="MARTES" sx={{":hover":bgcolor:#000}}>MARTES</MenuItem>
                                            <MenuItem value="MIERCOLES" sx={{":hover":bgcolor:#000}}>MIERCOLES</MenuItem>
                                            <MenuItem value="JUEVES" sx={{":hover":bgcolor:#000}}>JUEVES</MenuItem>
                                            <MenuItem value="VIERNES" sx={{":hover":bgcolor:#000}}>VIERNES</MenuItem>
                                        </Select>
                                    </FormControl>
                                </Grid>
                                <Grid item xs={2.5}>
