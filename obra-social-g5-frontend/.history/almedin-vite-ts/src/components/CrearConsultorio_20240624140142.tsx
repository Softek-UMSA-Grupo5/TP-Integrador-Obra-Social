...
import { MedicoRequest, MedicoRequestDto, MedicoResponseDto } from '../types/Medico';
...
const ConsultorioForm: React.FC = () => {
    ...
    try {
        ...
        if (createNewMedico) {
            ...
            const medicoResponse: MedicoResponseDto[] = await addMedico([medicoToCreate]);
            const medicoId = medicoResponse[0].id;
