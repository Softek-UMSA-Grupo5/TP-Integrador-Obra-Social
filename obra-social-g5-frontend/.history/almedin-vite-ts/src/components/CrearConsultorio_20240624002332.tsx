                                ...
                                <Grid item xs={4}>
                                    <FormControl fullWidth variant="outlined">
                                        ...
                                        <Select
                                            ...
                                            <MenuItem value="MARTES" sx={{":hover":}}>MARTES</MenuItem>
                                            <MenuItem value="MIERCOLES" sx={{":hover":}}>MIERCOLES</MenuItem>
                                            <MenuItem value="JUEVES" sx={{":hover":}}>JUEVES</MenuItem>
                                            <MenuItem value="VIERNES" sx={{":hover":}}>VIERNES</MenuItem>
                                        </Select>
                                    </FormControl>
                                </Grid>
                                <Grid item xs={2.5}>
