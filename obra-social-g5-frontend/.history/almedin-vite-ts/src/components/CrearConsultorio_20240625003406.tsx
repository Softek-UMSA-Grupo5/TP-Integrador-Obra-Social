                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={3}>
                                        <FormControl fullWidth>
                                            <InputLabel htmlFor="select-hora-inicio">
                                                Hora Inicio
                                            </InputLabel>
                                            <Select
                                                ...
                                                label="Hora Inicio"
                                                renderValue={(selected) => `${selected}:00`}>
                                    ...
                                    <Grid item xs={3}>
                                        <FormControl fullWidth>
                                            <InputLabel htmlFor="select-hora-fin">
                                                Hora Fin
                                            </InputLabel>
                                            <Select
                                    ...
                                    <Grid item xs={3}>
                                        <FormControl fullWidth>
                                            <InputLabel htmlFor="hora-inicio">
                                                Hora Inicio
                                            </InputLabel>
                                            <Input
                                                id="hora-inicio"
                                    ...
                                    <Grid item xs={3}>
                                        <FormControl fullWidth>
                                            <InputLabel htmlFor="hora-fin">Hora Fin</InputLabel>
                                            <Input
                                                id="hora-fin"
                                                type="text"
