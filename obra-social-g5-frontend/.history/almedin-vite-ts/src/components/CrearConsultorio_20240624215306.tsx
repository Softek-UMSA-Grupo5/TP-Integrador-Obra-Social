...
const ConsultorioForm: React.FC = () => {
    ...
    const formatTimeInput = (value: string): string => {
        // Limpia la entrada eliminando caracteres no numéricos
        ...
        // Asegura que las horas estén en el rango correcto (0-23)
        hours = String(Math.min(parseInt(hours, 10), 23)).padStart(2, '0');

        // Si no hay minutos, establece "00"; de lo contrario, usa los minutos ingresados
        const minutes = parts.length > 1 ? parts[1] : '00';

        // Si no hay segundos, establece "00"; de lo contrario, usa los segundos ingresados
