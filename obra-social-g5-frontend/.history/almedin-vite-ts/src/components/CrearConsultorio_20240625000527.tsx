...
const ConsultorioForm: React.FC = () => {
    ...
    const formatTimeInput = (value: string): string => {
        ...
        hours = parts.length > 0 ? String(Math.min(parseInt(parts[0], 10), 23)).padStart(2, '0') : '00';
        minutes = parts.length > 1 ? String(Math.min(parseInt(parts[1], 10), 59)).padStart(2, '0') : '00';
        seconds = parts.length > 2 ? '00' : '00'; // Segundos siempre '00'
