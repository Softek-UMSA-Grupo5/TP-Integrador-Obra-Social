...
const ConsultorioForm: React.FC = () => {
   ...
   const formatTimeInput = (value: string): string => {
    ...
    const minutes = parts[1] ? String(Math.min(parseInt(parts[1], 10), 59)).padStart(2, '0') : '00';
    const seconds = parts[2] ? String(Math.min(parseInt(parts[2], 10), 59)).padStart(2, '0') : '00';
