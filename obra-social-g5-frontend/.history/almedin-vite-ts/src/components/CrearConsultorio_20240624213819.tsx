...
const ConsultorioForm: React.FC = () => {
    ...
    const handleHorarioChange = (index: number, event: ChangeEvent<HTMLInputElement>) => {
        ...
        // Formatear la hora ingresada (asegura que minutos y segundos sean 00 si solo se ingresa la hora)
                                ...
                                <Grid item xs={3}>
                                    <FormControl fullWidth variant="outlined">
                                        ...
                                        <OutlinedInput
                                            ...
                                            onChange={(event: ChangeEvent<HTMLInputElement>) => handleHorarioChange(index, event)}
