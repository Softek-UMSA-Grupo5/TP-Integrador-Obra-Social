                                        ...
                                        <Grid container spacing={1}>
                                            ...
                                            <Grid item xs={6}>
                                                <FormControl
                                                    ...
                                                    variant="outlined"
                                                    sx={{ my: 0.5 }}>
                                                    <InputLabel shrink shrink sx={{fontWeight:'bold', fontSize:'16px'}}>CUIL</InputLabel>
                                                    <OutlinedInput
                                                        name="cuil"
                                            ...
                                            <Grid item xs={6}>
                                                <FormControl
                                                    ...
                                                    variant="outlined"
                                                    sx={{ my: 0.5 }}>
                                                    <InputLabel shrink shrink sx={{fontWeight:'bold', fontSize:'16px'}}>Especialidad</InputLabel>
                                                    <OutlinedInput
                                                        name="especialidad"
