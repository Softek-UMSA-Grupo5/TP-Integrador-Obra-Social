                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={6}>
                            <TextField
                                ...
                                InputProps={{
                                    inputProps: {
                                        style: { textAlign: 'left', MozAppearance: 'textfield' }, // Alineación del texto a la izquierda
                                        step: '1', // Paso del incremento/decremento
                                        min: '0', // Valor mínimo permitido
                                        pattern: '\\d*', // Patrón para permitir solo dígitos
                                        inputMode: 'numeric', // Modo de entrada numérico
                                    },
                                    disableUnderline: true, // Oculta la línea debajo del TextField
                                }}
                            />
                        </Grid>
                        <Grid item xs={6}>
