...
import {
  ...
  Button,
  Grid,
} from '@mui/material'; // Asegúrate de importar los componentes necesarios de Material-UI
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                  setFormData({
                    ...formData,
                    horarioAtencion: [{ ...formData.horarioAtencion[0], horaInicio: event.target.value }],
                  })
                }
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                  setFormData({
                    ...formData,
                    horarioAtencion: [{ ...formData.horarioAtencion[0], horaFin: event.target.value }],
                  })
                }
              />
            </Grid>
            <Grid item xs={12}>
              <TextField
                ...
                variant="outlined"
                onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                  setFormData({ ...formData, medico: { ...formData.medico, nombre: event.target.value } })
                }
              />
            </Grid>
            <Grid item xs={12}>
              <TextField
                ...
                variant="outlined"
                onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                  setFormData({ ...formData, ubicacion: { ...formData.ubicacion, calle: event.target.value } })
                }
              />
            </Grid>
            <Grid item xs={12} sm={4}>
              <TextField
                ...
                variant="outlined"
                onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                  setFormData({ ...formData, ubicacion: { ...formData.ubicacion, ciudad: event.target.value } })
                }
              />
            </Grid>
            <Grid item xs={12} sm={4}>
              <TextField
                ...
                variant="outlined"
                onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                  setFormData({ ...formData, ubicacion: { ...formData.ubicacion, provincia: event.target.value } })
                }
              />
            </Grid>
            <Grid item xs={12} sm={4}>
              <TextField
                ...
                variant="outlined"
                onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                  setFormData({ ...formData, ubicacion: { ...formData.ubicacion, codigo: event.target.value } })
                }
              />
            </Grid>
          </Grid>
