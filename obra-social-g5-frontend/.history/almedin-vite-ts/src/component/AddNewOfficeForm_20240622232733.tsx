                        ...
                        <Grid item xs={6}>
                            <TextField
                                ...
                                inputProps={{
                                    ...
                                    pattern: '[0-9]*',
                                    style: {
                                        MozAppearance: 'textfield', // Para ocultar las flechas de incremento/decremento en Firefox
                                        appearance: 'textfield', // Para ocultar las flechas de incremento/decremento en Chrome
                                    },
                                }}
                            />
                        </Grid>
