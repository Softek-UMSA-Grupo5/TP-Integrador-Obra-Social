        ...
        <Container maxWidth="lg" sx={{ py: 8 }}>
                ...
                <Grid container spacing={4}>
                    <Grid item xs={12} md={4}>
                        <Paper elevation={3} sx={{ p: 3, height: {xs:'max-content', md: 180, lg:150} }}>
                    ...
                    <Grid item xs={12} md={4}>
                        <Paper elevation={3} sx={{ p: 3, height: {xs:'max-content', sm:200, md: 150} }}>
                            <Typography variant="body1" paragraph>
                    ...
                    <Grid item xs={12} md={4}>
                        <Paper elevation={3} sx={{ p: 3, height: {xs:'max-content', md: 150} }}>
                            <Typography variant="body1" paragraph>
