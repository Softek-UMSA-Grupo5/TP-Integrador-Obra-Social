...
const ConsultorioForm: React.FC = () => {
    ...
    const fetchMedicos = async () => {
        try {
            ...
            const filteredMedicos = medicos.filter((medico) => !medico.estaEliminado); // Filtrar médicos no eliminados
            setExistingMedicos(filteredMedicos); // Establecer los médicos filtrados en el estado
        } catch (error) {
