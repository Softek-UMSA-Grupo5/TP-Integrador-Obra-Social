...
import { addMedico, getAll } from '../../assets/axios/MedicoApi';
import { createConsultorio } from '../../assets/axios/ConsultorioApi';
import { Medico, MedicoRequestDto, MedicoResponseDto } from '../../assets/models/Medico';
