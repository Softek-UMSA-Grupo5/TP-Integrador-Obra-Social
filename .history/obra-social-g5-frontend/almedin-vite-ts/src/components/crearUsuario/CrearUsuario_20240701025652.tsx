...
const UsuarioForm: React.FC = () => {
    ...
    try {
        ...
        // Asignar el rol correspondiente a usuarioData
        usuarioData.rol = isExistingMedico ? UsuarioRolesEnum.ROL_MEDICO : selectedRol;

        // Registrar o actualizar usuario
        await registrarUsuario(usuarioData, usuarioData.rol);

        // Obtener el usuario por username para obtener usuarioId
        const usuarioResponse = await getUserByUsername(usuarioData.username);
        usuarioId = usuarioResponse.id;

        // Crear o actualizar el médico según el caso
        if (isNewMedico) {
            // Crear médico nuevo
