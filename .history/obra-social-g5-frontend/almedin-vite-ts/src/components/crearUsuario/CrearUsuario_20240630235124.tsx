...
import { getAllMedicos, addMedico, updateMedico, getUserByUsername } from '../../assets/axios/MedicoApi';
...
const UsuarioForm: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            await registrarUsuario(usuarioData, isExistingMedico ? UsuarioRolesEnum.ROL_MEDICO : selectedRol);
