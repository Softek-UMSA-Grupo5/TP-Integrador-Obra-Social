...
const MedicoForm: React.FC<MedicoFormularioNuevoProps> = ({ medicoData, setMedicoData }) => {
   ...
   const handleBlur = (event: React.FocusEvent<HTMLInputElement>) => {
    ...
    const formFields = [
        ...
        {name: 'fechaNacimiento',label: '',type: 'date',required: true,error: !!errors.fechaNacimiento,helperText: errors.fechaNacimiento,initialValue: medicoData?.fechaNacimiento,},
