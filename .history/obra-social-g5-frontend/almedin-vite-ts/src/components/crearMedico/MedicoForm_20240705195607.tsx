...
const MedicoForm: React.FC<MedicoFormularioNuevoProps> = ({ medicoData, setMedicoData }) => {
    ...
    const handleInputChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (name === 'dni') {
            // Solo permitir números y limitar la longitud a 8 caracteres (ejemplo de DNI argentino)
            if (!/^\d{0,8}$/.test(value)) {
   ...
   const handleBlur = (event: React.FocusEvent<HTMLInputElement>) => {
    ...
    const formFields = [
        ...
        {name: 'dni',label: 'N° de Documento',type: 'text',required: true,error: !!errors.dni,helperText: errors.dni,initialValue: '',},
        {name: 'fechaNacimiento',label: '',type: 'date',required: true,error: !!errors.fechaNacimiento,helperText: errors.fechaNacimiento,},
        ...
        {name: 'especialidad',label: 'Especialidad',
            ...
            error: !!errors.especialidad,helperText: errors.especialidad,
        },
