...
const MedicoForm: React.FC<MedicoFormularioNuevoProps> = ({medicoData, setMedicoData }) => {
   ...
   const handleBlur = (event: React.FocusEvent<HTMLInputElement>) => {
    ...
    const formFields = [
        ...
        {name: 'fechaNacimiento',shrink: true,shrinkLabel: 'Fecha', label: 'Fecha de Nacimiento',type: 'date',required: true,error: !!errors.fechaNacimiento,helperText: errors.fechaNacimiento,},
